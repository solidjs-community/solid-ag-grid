...
const UserComp = (p: { compDetails: UserCompDetails; ref?: any }) => {
  ...
  return (
    <>
      {showSolidComp() && <SolidUserComp compDetails={p.compDetails} ref={p.ref} />}
      {showJsComp() && <JsUserComp compDetails={p.compDetails} ref={p.ref} />}
    </>
  );
};
