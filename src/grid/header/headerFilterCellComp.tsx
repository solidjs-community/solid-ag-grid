...
const HeaderFilterCellComp = (props: { ctrl: HeaderFilterCellCtrl }) => {
  ...
  const [getCssButtonWrapperClasses, setButtonWrapperCssClasses] = createSignal<CssClasses>(
    new CssClasses(),
  );
  const [getButtonWrapperAriaHidden, setButtonWrapperAriaHidden] = createSignal<"true" | "false">(
    "false",
  );
  ...
  const getCssClassesString = createMemo(
  ...
  const getButtonWrapperCssClassesString = createMemo(
